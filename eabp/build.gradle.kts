...
// The EABP library: protocol, renderer, offline queue, and the OS surfaces
...
// and names no host class (launch goes through EabpLaunch, editor toolbars
// through the EabpToolbars registry).
android {
    namespace = "com.calebc42.eabp.core"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
