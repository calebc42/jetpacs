...
;;; ==================================================================
;;; BEGIN core/jetpacs-devtools.el
;;; ==================================================================
...
\"Saved NAME\" on a view that isn't being sent."
  ...
  (condition-case err
      (let* ((active (jetpacs-shell--active-view))
             ...
             ;; push (the :when-gated editor the user is looking at, which is
             ;; neither the active tab nor an overlay); else to TARGET — a
             ;; navigation push lands the user there, not on the view they're
             ;; leaving — or the active view.  The visibility guard keeps an
             ;; offline-replayed save whose editor has since closed from
             ;; orphaning "Saved NAME" on a view that isn't in this push.
             (snack-target (or (and snack-view (assoc snack-view visible) snack-view)
                               target active))
...
;;; ==================================================================
;;; BEGIN core/jetpacs-app-store.el
;;; ==================================================================
