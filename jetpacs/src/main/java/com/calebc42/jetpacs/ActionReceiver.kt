 ...
 * presses, state changes) into Jetpacs frames.
 *
...
class ActionReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        thread(name = "JetpacsActionDispatch") {
            try {
                when (intent.action) {
    ...
    companion object {
        const val ACTION_TAP = "com.calebc42.jetpacs.ACTION_TAP"
        const val ACTION_STATE_CHANGED = "com.calebc42.jetpacs.ACTION_STATE_CHANGED"
